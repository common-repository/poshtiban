        ...
        <table class="widefat">
			...
			<?php foreach ( $downloads as $checksum => $download ):
                ...
                <tr class="mirror_row">
                    ...
                    <td width="10%">
                        <a href="#"
                           class="<?php echo sprintf( '%s_send_to_mirror no_padding button %s_tooltip',
							   \Poshtiban\Main::$slug, \Poshtiban\Main::$slug ) ?>"
                           data-tooltip="<?php _e( 'Upload to mirror server', $text_domain ); ?>"
                           data-id="<?php echo $variation->ID ?>"><span class="spinner"></span> <span
                                    class="dashicons dashicons-controls-repeat"></span></a>
						<?php if ( isset( $mirror_download['id'] ) && ! empty( $mirror_download['id'] ) ): ?>
                            <a href="#"
                               class="<?php echo sprintf( '%s_get_download_link no_padding button %s_tooltip',
								   \Poshtiban\Main::$slug, \Poshtiban\Main::$slug ) ?>"

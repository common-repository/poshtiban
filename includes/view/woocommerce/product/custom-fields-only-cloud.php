...
?>
<div class="options_group show_if_downloadable <?php printf('%s_files_group', $slug) ?>">
        ...
        <table class="widefat <?php printf('%s_files_table', $slug) ?>">
                ...
                <tr class="mirror_row">
                    ...
                    <td style="width: 17px;">
                        <label for="manually_insert"
                               ...
                               class="<?php printf('%s_tooltip', $slug) ?>"><input id="manually_insert" type="checkbox"
                                                                value="yes"></label>
                    </td>
                    <td class="file_id">
                        <input type="text" class="input_text"
                               placeholder="<?php _e( 'File ID', $text_domain ); ?>"
                               name="<?php printf('_%s_downloadable_files_ids[]', $slug) ?>" value="" disabled readonly>
                    </td>
                    <td class="file_name">
                        <input type="text" class="input_text"
                               placeholder="<?php _e( 'File name', $text_domain ); ?>"
                               name="<?php printf('_%s_downloadable_files_names[]', $slug) ?>" value="" disabled readonly>
                    </td>
                    <td class="file_path">
			...
			<?php else:
                foreach ( $files as $file_id => $file ) {
	                ...
	                Helper::view( 'product/custom-fields-only-cloud-item', 'woocommerce', $args );
                }
                endif;
            ?>
            ...
            <tr>
                <th colspan="7">
                    <a href="#" class="button insert" data-row="<tr class=&quot;mirror_row&quot;>
						...
						$text_domain ); ?>&quot; class=&quot;<?php printf('%s_tooltip', $slug) ?>&quot;><input id=&quot;manually_insert&quot; type=&quot;checkbox&quot; value=&quot;yes&quot;></label>
                            </td>
<td class=&quot;file_id&quot;>
    <input type=&quot;text&quot; class=&quot;input_text&quot; placeholder=&quot;<?php _e( 'File ID',
						$text_domain ); ?>&quot; name=&quot;<?php printf('_%s_downloadable_files_ids[]', $slug) ?>&quot; value=&quot;&quot; disabled readonly>
</td>
<td class=&quot;file_name&quot;>
    <input type=&quot;text&quot; class=&quot;input_text&quot; placeholder=&quot;<?php _e( 'File name',
						$text_domain ); ?>&quot; name=&quot;<?php printf('_%s_downloadable_files_names[]', $slug) ?>&quot; value=&quot;&quot; disabled readonly>
</td>
<td class=&quot;file_path&quot;>
    <input type=&quot;text&quot; class=&quot;input_text&quot; placeholder=&quot;&quot; value=&quot;/Patition's home/<?php echo $upload_path; ?>/&quot;
           disabled readonly>
</td>
<td class=&quot;file_url_choose&quot; width=&quot;1%&quot;><a href=&quot;<?php echo esc_url( $image_library_url ); ?>&quot; title=&quot;<?php printf(__( 'Select file from %s', $text_domain ), \Poshtiban\Main::$name); ?>&quot; class=&quot;button thickbox <?php printf('%s_file_selector', $slug) ?>&quot; onclick=&quot;cloudAddClass(this)&quot; data-choose=&quot;Choose file&quot;
                                          data-update=&quot;Insert file URL&quot;><?php _e( 'Choose file',
						$text_domain ); ?></a>
</td>
<td width=&quot;1%&quot;>
    <a href=&quot;#&quot; class=&quot;<?php echo sprintf( '%s_get_download_link no_padding button %s_tooltip', $slug,  $slug ) ?>&quot;
